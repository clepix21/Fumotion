-- ============================================
-- FUMOTION - Schéma complet de la base de données
...
-- Contient les informations de profil, authentification et statut
...
-- Table des véhicules
-- Véhicules enregistrés par les utilisateurs (conducteurs)
...
-- Table des trajets
-- Annonces de covoiturage publiées par les conducteurs
...
-- Liens entre passagers et trajets
...
-- Avis laissés par les utilisateurs (conducteurs ou passagers)
...
-- Table des messages
-- Messagerie interne entre utilisateurs liée ou non à un trajet
